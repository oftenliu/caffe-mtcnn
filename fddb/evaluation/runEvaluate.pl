...
#### VARIABLES TO EDIT ####
# where gnuplot is
my $GNUPLOT = "/home/often/usr/gnuplot-5.2.4/bin/gnuplot"; 
# where the binary is
my $evaluateBin = "./evaluate"; 
# where the images are
my $imDir = "/home/often/often/caffe-mtcnn/fddb/originalPics/"; 
# where the folds are
my $fddbDir = "/home/often/often/caffe-mtcnn/fddb/FDDB-folds/"; 
# where the detections are
my $detDir = "/home/often/often/caffe-mtcnn/fddb/Res/"; 
###########################
